...
type HamburgerMenu() as self =
    ...
    member this.TabControl = this.FindControl<TabControl>("PART_TabControl")
...
module HamburgerMenuBuilders =
    ...
    type Fabulous.Avalonia.View with
        ...
        static member inline HamburgerMenu() =
            CollectionBuilder<'msg, IFabHamburgerMenu, IFabTabItem>(HamburgerMenu.WidgetKey, HamburgerMenu.Items)
